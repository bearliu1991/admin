          ...
          <div class="survey-wrapper">
            ...
            <div class="left">
              <div class="left-wrapper info">
                <div class="name">杭州星客迎客通互联科技有限...</div>
                <div class="date">
                  <div>{{corpPackageData.packageName}}版</div>
                ...
                <div class="tips-info" v-show="corpPackageData.packageName!=='免费'">
                  当前为{{corpPackageData.packageName}}版，升级套餐，享更多特权服务
                </div>
                <div class="butn">
                  立即升级
                </div>
...
import { getToken, setCookie } from '@/assets/js/cookies'
