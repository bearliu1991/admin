<template>
  <div id="seats">
    <scroll-bar>
      <data-loading :data-satau='beginIntoLoading'>
        <div class="scroll-common-content">
          <div class="seats-main">
            ...
            <div class="noseats-wrapper" v-show="showNoData">
              <no-seats @addSeats="addSeats"></no-seats>
            </div>
    ...
    <drawer v-model="showFilter">
      ...
      <div slot="footer">
        <div class="footer-wrapper">
          ...
          <Button class="footer-btn" type="ghost"  @click="filterCancal">取消</Button>
        </div>
      </div>
    </drawer>
    ...
    <add-seats :createSeat="createSeat" ref="addSeats"></add-seats>
    ...
    <common-modal ref="addseatsTips" header="套餐不足" confrim="立即升级" :content="content" @ok="upgrade" ></common-modal>
  </div>
</template>
