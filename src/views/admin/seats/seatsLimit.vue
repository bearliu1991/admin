  ...
  methods: {
    ...
    isGoNext() {
      if (
        ...
        let authIds = this.checkAllGroup.dialogCheckAllGroup.concat(this.checkAllGroup.fansCheckAllGroup)
        return {
          authIds: authIds,
    ...
    showCheckBoxStatu() {
      ...
      //
      if (this.checkAllGroup.dialogCheckAllGroup.length === this.corpPackRoleList[0].roleId.length) {
        this.indeterminate.dialogIndeterminate = false
        this.checkAll.dialogCheckAll = true
      ...
      //
      if (this.checkAllGroup.fansCheckAllGroup.length === this.corpPackRoleList[1].roleId.length) {
        this.indeterminate.fansIndeterminate = false
        this.checkAll.fansCheckAll = true
      ...
      //
      if (
        this.checkAllGroup.fansCheckAllGroup.length === this.corpPackRoleList[1].roleId.length &&
        this.checkAllGroup.dialogCheckAllGroup.length === this.corpPackRoleList[0].roleId.length
      ) {
        this.indeterminate.limitIndeterminate = false
