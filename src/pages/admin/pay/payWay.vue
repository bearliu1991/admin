      ...
      <div class="payee-info">
        <div class="payee-info-wrapper">
          <div class="payee-info-item">
            ...
            <span class="text2">杭州洋财信息技术有限公司</span>
          </div>
          <div class="payee-info-item">
            <span class="text1">收款方开户行</span>
            <span class="text2">招商银行股份有限公司杭州高新支行</span>
          </div>
          <div class="payee-info-item">
            <span class="text1">收款方账户</span>
            <span class="text2">5719 0782 1710 904</span>
          </div>
          <div class="payee-info-item">
...
export default {
  ...
  mounted() {
    this.formQrcodeParams({orderId: this.getCookie('orderId')})
  },
  methods: {
    isCanPayVoucher() {
      isCanPayVoucher({
